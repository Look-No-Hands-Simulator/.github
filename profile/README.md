...
- Install Ubuntu 20.04 by having an empty USB stick, downloading Ubuntu onto it using a software such as [balena etcher](https://etcher.balena.io/), plug it into a computer, now create a dual boot by splitting the memory, or alternatively download it onto an external SSD drive.
