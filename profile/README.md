...
## ROS2-interface
Sensor msgs are published to ROS topics the topic names can be seen and changed inside the Unity GameObjects. Control and state msgs published onto ROS topics of appropriate FSAI API names are used to control the vehicle inside Unity.
## Sensors simulations
### GPS
